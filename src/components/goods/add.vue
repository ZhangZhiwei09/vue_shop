<template>
  <div>
    ...
    <el-dialog title="图片预览" :visible.sync="previewDialogVisible" width="40%" >
  ...
  methods: {
    ...
    addGoods () {
      this.$refs.addFormRef.validate(async valid => {
        ...
        if (res.meta.status !== 201) return this.$message.error('添加商品失败！请检查是否输入有误')
